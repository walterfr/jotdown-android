...
interface SyncProvider {
    ...
    suspend fun findDriveFolderByName(context: Context, name: String): Result<DriveFileInfo?>
    /** Lists all PDF files inside the given Drive folder ID. */
    suspend fun listDrivePdfs(context: Context, folderId: String): Result<List<DriveFileInfo>>
