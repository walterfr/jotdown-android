...
abstract class DocumentDao {
    ...
    @Query("UPDATE documents SET readingStatus = :status WHERE id = :id")
    abstract suspend fun updateReadingStatus(id: String, status: String): Int
